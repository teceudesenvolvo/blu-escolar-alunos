...
const dashboardData = {
    ...
    barChartData: [
        { name: 'Educ. Infantil 1', matriculas: 2500, fill: '#F7859D' },
        { name: 'Educ. Infantil 2', matriculas: 3100, fill: '#F7859D' },
        { name: '1º Ano', matriculas: 1800, fill: '#d8b4fe' },
        { name: '2º Ano', matriculas: 2200, fill: '#d8b4fe' },
        { name: '3º Ano', matriculas: 2500, fill: '#d8b4fe' },
        { name: '4º Ano', matriculas: 2000, fill: '#d8b4fe' },
        { name: '5º Ano', matriculas: 2800, fill: '#d8b4fe' },
        { name: '6º Ano', matriculas: 3000, fill: '#d8b4fe' },
        { name: '7º Ano', matriculas: 2100, fill: '#d8b4fe' },
        { name: '8º Ano', matriculas: 2500, fill: '#d8b4fe' },
        { name: '9º Ano', matriculas: 3200, fill: '#d8b4fe' },
    ],
    lineChartData: [
        { name: 'Janeiro', matriculas: 0 },
        { name: 'Fevereiro', matriculas: 2500 },
        { name: 'Março', matriculas: 1800 },
        { name: 'Abril', matriculas: 1200 },
        { name: 'Maio', matriculas: 3500 },
        { name: 'Junho', matriculas: 2800 },
        { name: 'Julho', matriculas: 1500 },
        { name: 'Agosto', matriculas: 9000 },
        { name: 'Setembro', matriculas: 1000 },
        { name: 'Outubro', matriculas: 4500 },
        { name: 'Novembro', matriculas: 7000 },
        { name: 'Dezembro', matriculas: 6500 },
    ]
};
...
const DashboardSME = () => {
    ...
    return (
        <div className="sme-dashboard-container">
            ...
            <section className="sme-chart-card">
                ...
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    >
                        ...
                        <Tooltip />
                        <Bar dataKey="matriculas" fill="#8884d8" barSize={20} />
                    </BarChart>
                </ResponsiveContainer>
            </section>
            ...
            <section className="sme-chart-card">
                <div className="sme-chart-legend">
                    <p className="sme-legend-item">Crescimento de Matrículas</p>
                    <select className="sme-year-selector">
                        <option>Todos</option>
                        <option>2024</option>
                        <option>2025</option>
                    </select>
                ...
                <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={dashboardData.lineChartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Line type="monotone" dataKey="matriculas" stroke="#F7859D" strokeWidth={2} activeDot={{ r: 10 }} />
                    </LineChart>
                </ResponsiveContainer>
            </section>
        </div>
